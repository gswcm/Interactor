<?php
	if(isset($_GET['name'])) {
		...
		$result = file_get_contents('https://gsw.gabest.usg.edu/pls/B420/bwckctlg.p_disp_course_detail?cat_term_in='.$_GET['term'].'&subj_code_in='.$_GET['subj'].'&crse_numb_in='.$_GET['numb']);
	}
